...
class SADE_FRE():
    def __init__(self, initSize=200,maxiter=100,error=1e-03,R=None,b=None):
        ...
        self.population = np.random.exponential(0.6,(self.pplSize,self.R.shape[1]))
    ...
    def run(self):
        ...
        while (i<self.maxiter):
            ...
            if(updatecount==0):
                ...
                #top = current_gen[top]
                regenCount+=1
                current_gen = np.random.exponential(0.3,(self.pplSize,self.R.shape[1]))
        ...
        print(f'SADE_exp Run Completed : Best Score: {overallBest} ,  find in Gen: {bestGen}, ReGenCount: {regenCount:3d}, totalRuntime: {(totalEnd):4.5f}')
