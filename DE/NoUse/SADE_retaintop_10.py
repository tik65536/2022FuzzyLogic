    ...
    def run(self):
        ...
        while (i<self.maxiter):
            ...
            if(updatecount==0):
                ...
                top = current_gen[top]
                regenCount+=1
                newGen = np.random.random((self.pplSize-10,self.R.shape[1]))
                current_gen=np.vstack((top,newGen))
            ...
            if(abs(overallBest-currentbest) < self.error):
            ...
            if(currentbest<overallBest):
                ...
                overallBestConfig = current_gen[currentbestidx]
                bestGen = i
            print(f'SADE_retain Run {i:3d} CurrentBest: {currentbest:10.8f}, OverallBest: {overallBest:10.8f}/{bestGen:3d}, Generation RunTime: {(end-start):10.8f}')
